          ...
          <nav className="flex items-center">
            ...
            <SignedOut>
              <button
                ...
                className="bg-white text-teal-600 py-2 px-4 rounded-md hover:bg-teal-100 focus:outline-none focus:ring-2 focus:ring-teal-500 focus:ring-offset-2 transition duration-300"
              >
                Sign In
              </button>
            </SignedOut>
